        ...
        <div class="container ">
			...
			<div class="row h-100 align-items-center text-center">
				 <div class="col-md-12">
				     ...
				     <h6 class="display-4 has-line">TRAINING PROCESS </h6>
					<form method="POST" enctype="multipart/form-data">
						...
						<button type="submit" class="btn btn-primary btn-lg" name="submit">Process Now<br></button><br><br>	
					</form>
				</div>
			</div>
			<?php
			...
			{
				move_uploaded_file($_FILES['f1']['tmp_name'],"dataset/creditcard.csv");
			
				$python = `python train.py`;
				
				echo"<h2>Training Completed.....</h2>";
